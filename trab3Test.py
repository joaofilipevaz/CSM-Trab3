...
# Chrominance quantize Matrix  
QC= np.zeros((8, 8))
QC[0] = [ 17,  18,  24,  99,  99,  99,  99,  99]
QC[1] = [ 18,  21,  26,  66,  99,  99,  99,  99]
QC[2] = [ 24,  26,  56,  99,  99,  99,  99,  99]
QC[3] = [ 47,  66,  99,  99,  99,  99,  99,  99]
QC[4] = [ 99,  99,  99,  99,  99,  99,  99,  99]
QC[5] = [ 99,  99,  99,  99,  99,  99,  99,  99]
QC[6] = [ 99,  99,  99,  99,  99,  99,  99,  99]
QC[7] = [ 99,  99,  99,  99,  99,  99,  99,  99]
